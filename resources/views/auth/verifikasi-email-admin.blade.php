...
<body>
    <div class="card">
        ...
        <p>
            Terima kasih telah mendaftar! Sebelum melanjutkan, silakan periksa email Anda dan klik tautan verifikasi
        ...
        <p>
            <a href="{{ route('admin.logout') }}"
                onclick="event.preventDefault(); document.getElementById('keluar-form').submit();">
                Keluar dari akun
            </a>
        </p>

        <form id="keluar-form" method="POST" action="{{ route('admin.logout') }}" style="display: none;">
            @csrf
        </form>
    </div>
</body>
